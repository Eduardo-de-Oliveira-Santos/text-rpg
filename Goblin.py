...
def batalha():
    while 1:
        ...
        if Monstros_vars.vida_goblin <= 0:
            print("voçe derrotou o goblin!!!!")
        ...
        limpa_tela()
        print("▬▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print(f'{Fore.RED}۩goblin۩{Fore.RESET}                 vida:',Monstros_vars.vida_goblin)
        print("▬▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print("")
        print("")
        print("")
        ...
        if Variaveis.text == 1:
            ...
            dano_inimigo = random.randrange(0, 11) + Monstros_vars.força_goblin
            ...
            if miss > 20 and miss_inimigo <= 10:
                ...
                Monstros_vars.vida_goblin -= dano
