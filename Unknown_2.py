...
def batalha():
    while 1:
        ...
        if Monstros_vars.vida_LV <= 0:
            print("voçe derrotou o LV!!!!")
        ...
        limpa_tela()
        print("▬▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print(f'{Fore.RED}۩LV۩{Fore.RESET}                 vida:',Monstros_vars.vida_LV)
        print("▬▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print("")
        print("")
        print("")
        ...
        if Variaveis.text == 1:
            ...
            dano_inimigo = random.randrange(0, 11) + Monstros_vars.força_LV
