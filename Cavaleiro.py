...
def batalha():
    while 1:
        ...
        if Monstros_vars.vida_cavaleiro <= 0:
            print("voçe derrotou o cavaleiro!!!!")
        ...
        limpa_tela()
        print("▬▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print(f'{Fore.RED}۩cavaleiro۩{Fore.RESET}                 vida:',Monstros_vars.vida_cavaleiro)
        print("▬▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print("")
        print("")
        print("")
        ...
        if Variaveis.text == 1:
            ...
            dano_inimigo = random.randrange(0, 11) + Monstros_vars.força_cavaleiro
            ...
            if miss > 20 and miss_inimigo <= 10:
                ...
                Monstros_vars.vida_cavaleiro -= dano
