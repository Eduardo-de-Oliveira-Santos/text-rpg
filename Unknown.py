...
def batalha():
    while 1:
        ...
        if Monstros_vars.vida_3R <= 0:
            print("voçe derrotou o 3R!!!!")
        ...
        limpa_tela()
        print("▬▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print(f'{Fore.RED}۩3R۩{Fore.RESET}                 vida:',Monstros_vars.vida_3R)
        print("▬▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print("")
        print("")
        print("")
        ...
        if Variaveis.text == 1:
            ...
            dano_inimigo = random.randrange(0, 11) + Monstros_vars.força_3R
